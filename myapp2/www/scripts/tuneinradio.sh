...
if [ $1 = "4" ]; then
String98="timeout 1h mpv --quiet --vo=null -ao=null --stream-record=/var/www/html/recordings/tunein$current_time.mp3 http://opml.radiotime.com/Tune.ashx?id=${1}&formats=aac,mp3 > /dev/null 2>&1 &"
eval "$String98"
fi
